...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    JS_LEFT_GUI, JS_Z        , JS_X     , JS_C         , JS_V     , JS_B     ,                            JS_N     , JS_M     , JS_COMM  , JS_DOT   , JS_SLSH  , JS_RIGHT_GUI  ,
                 JS_LALT     , JS_LCTL  ,LT(1,JS_LNG2),LT(2,JS_SPC),LT(3,JS_LNG1),JS_BSPC,LT(2,JS_ENT),XXXXXXX , XXXXXXX  , LT(3,JS_ESC)
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , XXXXXXX   , JS_1     , JS_2     , JS_3     , XXXXXXX  ,                            JS_PGDN  , JS_BTN4  , JS_BTN3  , JS_BTN5  , XXXXXXX  , _______  ,
               _______   , _______  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,      JS_DEL  ,  JS_RALT  , XXXXXXX  , XXXXXXX  , _______
  ),

  [3] = LAYOUT_universal(
    _______  , XXXXXXX   , JS_F7    , JS_F8    , JS_F9    , JS_F10   ,                            XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX , XXXXXXX , _______  ,
    ...
    _______  , XXXXXXX   , JS_F1    , JS_F2    , JS_F3    , JS_F12   ,                            SCRL_DVI , CPI_D100 , XXXXXXX  , XXXXXXX , XXXXXXX , _______  ,
               _______   , _______  , KBC_RST  , KBC_SAVE , XXXXXXX  ,      XXXXXXX ,  XXXXXXX  , XXXXXXX  , XXXXXXX  , _______
  ),
};
// clang-format on
